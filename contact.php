...
<html>
<head>
	<title>NK & N STORES | CONTACT</title>
			...
			<div class="contact-main">
				...
				<div class="contact-top">
					<p style="text-transform: uppercase; text-align: center;">
						If you have a question about our services / products, drop us a line.
					</p>
				</div>
				<div class="contact-bottom">
					<div class="col-md-9 contact-left">
						...
						<div class="s-btn">
							<form action="email_script.php" name="yourForm" onsubmit="return(validate());" method="POST">
					...
					<div class="col-md-3 contact-right">
						<div class="contact-right-top">
								<a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><div class="clearfix"></div></a>
								<h4>81B, Federal Housing Kado Bimko,<label>Abuja, Nigeria</label></h4>
							</div>
							<div class="contact-right-top">
								<a href="#"><i class="fa fa-envelope" aria-hidden="true"></i><div class="clearfix"></div></a>
								
								<p><a href="mailto:nkiru.nnamdi@gmail.com">nkiru.nnamdi@gmail.com</a></p>
							</div>
							<div class="contact-right-top">
								<a href="#"><i class="fa fa-phone" aria-hidden="true"></i><div class="clearfix"></div></a>
								<p>+2347030235799</p>
							</div>
					</div>
